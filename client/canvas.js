...
Ext.ux.Ribbon = Ext.extend(Ext.TabPanel, {
	initComponent: function() {
		...
		if(!this.items) {
			this.items = [new Ext.ux.ToolsTab({
				title: 'Tools',
				ref: 'toolsTab'
...
/**
 * @class Ext.ux.MotifPalette
 * Allows motifs to be added to workspace by drag and drop
 */
Ext.ux.MotifPalette = Ext.extend(Ext.Panel, {
	initComponent: function() {
		Ext.apply(this, {
			items: [{
				xtype:'dataview',
		...
		Ext.ux.MotifPalette.superclass.initComponent.apply(this,arguments);
...
Ext.ux.ObjectProperties = Ext.extend(Ext.ux.BoundObjectPanel, {
