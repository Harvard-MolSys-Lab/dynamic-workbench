...
var libs = ['jquery-1.5.1.min', 'underscore', 'string', 'color-field-1.0.0/color-field', //
	'raphael-' + raphaelVersion + '/raphael-min', 
	'raphael-' + raphaelVersion + '//plugins/raphael.primitives', //
	...
	'jquery-animate-css-rotate-scale/jquery-animate-css-rotate-scale', 
	'Ext.ux.StatusBar', //
	'protovis-3.2/protovis-d3.2', 
	'd3-v2/d3.v2', 
	'/extjs-boxselect/src/BoxSelect', 
	'object-browser/ObjectBrowser', //
