 ...
 *
 * Defines {Workspace.objects.ElementObject} subclasses ({Workspace.Object}s built around simple,
 * non-vector graphic HTML elements)
 ***********************************************************************************************/
Ext.ns('Workspace.objects')
...
////////////////////////////////////////////////////////////////////////////////////////////////
/**
 * @class Workspace.objects.EmbedObject
 * Represents a workspace object containing an embed.ly preview
 * @extends Workspace.objects.ElementObject
 */
Workspace.objects.EmbedObject = {};
Ext.define('Workspace.objects.EmbedObject', {
	alias: 'Workspace.EmbedObject',
	constructor: function(workspace, config) {
		Workspace.objects.EmbedObject.superclass.constructor.call(this, workspace, config);
		...
		this.expose('url', true, true, true, false);
		//'getText', 'setText'); //,'text','string');
		this.on('change:url', this.updateUrl, this)
	},
	extend: 'Workspace.objects.ElementObject',
	wtype: 'Workspace.objects.EmbedObject',
	name: 'New Web Object',
	iconCls: 'image-icon',
	width: 300,
	height: 300,
	...
	render: function() {
		...
		Workspace.objects.EmbedObject.superclass.render.call(this, arguments);
	...
	updateWidth: function(w) {
		...
		Workspace.objects.EmbedObject.superclass.updateWidth.apply(this, arguments);
	},
	/**
	 * updateHeight
	 * Updates the element's dimensions. Called automatically when height property is changed
