Ext.define('App.ui.nodal.StrandPreview', {
	...
	setValue : function(motif) {
		...
		var ports = {
			init : (Workspace.objects.dna.Motifs[motif].indexOf('init') != -1),
			input : (Workspace.objects.dna.Motifs[motif].indexOf('input') != -1),
			pink : (Workspace.objects.dna.Motifs[motif].indexOf('pink') != -1),
			blue : (Workspace.objects.dna.Motifs[motif].indexOf('blue') != -1),
			green : (Workspace.objects.dna.Motifs[motif].indexOf('green') != -1),
			purple : (Workspace.objects.dna.Motifs[motif].indexOf('purple') != -1),
		};
