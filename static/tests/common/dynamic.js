...
test("printDomainString", function() {
	...
	var input1 = 'A[a x:c b c]i+ s[s(1)]x B[d e y:c c*]o- C[b* x*:c f g]o+', //
	...
	deepEqual(input1, App.dynamic.Compiler.printDomainString(doms1));
	deepEqual(input2, App.dynamic.Compiler.printDomainString(doms2));
	deepEqual(input3, App.dynamic.Compiler.printDomainString(doms3));
})
