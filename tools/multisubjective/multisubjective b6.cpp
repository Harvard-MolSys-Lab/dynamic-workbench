// Multisubjective, a nucleic acid sequence design program - version 1.0 beta 6, 2012-06-15
// by John P. Sadowski
// Do not distribute
...
const int strandsize = 50;	// number of strands
...
void savesettings()
{
	...
	strcat(filename, "/Documents/Multisubjective");
...
void outputlog()
{
	...
	cout << basetochar(basecollide(R, Y, 0, 0)) << endl;
